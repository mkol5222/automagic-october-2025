...
ls -rt ../_flowlogs/tmp* | xargs cat | jq -r '.records[]| .macAddress as $mac |.flowRecords.flows[] | .flowGroups[]| .rule as $rule | .flowTuples[] | "\(.),\($rule),\($mac)" '  | grep 10.69.200.4 | sort -t, -k1,1
